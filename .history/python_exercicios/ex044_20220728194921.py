...
if opcao == 1:
    ...
    print('O valor da compra sera dividido em 2x SEM JUROS e sera: R${:.2f}'.format(preco))
elif opcao == 4:
    total = preco * 1.2
    parcela = int(input('Quantas parcelas? '))
    valorparcela = total / parcela
    print('O valor da compra de R${:.2f} vai ser dividido em {}x COM JUROS'.format(preco, parcela))
    print('O valor das parcelas sera de R${:.2f} e a compra passa a custar1: R${:.2f}'.format(valorparcela, total))

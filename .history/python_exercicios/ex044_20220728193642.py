...
if opcao == 1:
    total = preco * 0.9
    print('O valor da compra de R${:.2f} com desconto sera: R${:.2f}!'.format(preco))
elif opcao == 2:
    preco = preco * 0.95
    print('O valor com desconto sera: R${:.2f}'.format(preco))
elif opcao == 3:
    print('O valor sera: R${:.2f}'.format(preco))
elif opcao == 4:
    preco = preco * 1.2
    parcela = int(input('Quantas parcelas? '))
    print('O valor com juros passa a ser: R${:.2f} '.format(preco))
